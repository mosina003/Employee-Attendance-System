...
import { FaUser, FaEnvelope, FaIdCard, FaBuilding, FaUserCircle, FaArrowLeft, FaEdit, FaSave, FaTimes } from 'react-icons/fa';
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="ml-4 flex-1">
                ...
                {isEditing ? (
                  <input
                    ...
                    className="text-lg font-semibold text-gray-900 border border-gray-300 rounded-lg px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                ) : (
          ...
          <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-sm text-blue-800">
              <strong>Note:</strong> You can update your name, email, and department using the Edit Profile button above.
            </p>
          </div>
        </div>
      </div>
